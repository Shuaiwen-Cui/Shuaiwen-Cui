...
@REM git push -f https://github.com/Shuaiwen-Cui/Shuaiwen-Cui.git main
git push -f https://github.com/Shuaiwen-Cui/Shuaiwen-Cui.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/Shuaiwen-Cui.git
